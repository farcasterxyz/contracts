...
contract NameRegistryTest is Test {
    ...
    function testCannotGenerateCommitWithInvalidName(
        address alice,
        bytes32 secret,
        address recovery
    ) public {
    ...
    function testCannotMakeCommitDuringTrustedRegister(
        address alice,
        bytes32 secret,
        address recovery
    ) public {
    ...
    function testSafeTransferFromOwner(
        address alice,
        address bob,
        address recovery
    ) public {
    ...
    function testSafeTransferFromApprover(
        address alice,
        address bob,
        address approver,
        address recovery
    ...
    function testCannotSafeTransferIfFnameExpired(
        address alice,
        address bob,
        address recovery
    ) public {
    ...
    function testCannotSafeTransferFromIfPaused(
        address alice,
        address bob,
        address recovery
    ) public {
    ...
    function testCannotSafeTransferFromIfNotOwner(
        address alice,
        address bob,
        address recovery
    ) public {
    ...
    function testCannotSafeTransferFromToZeroAddress(
        address alice,
        address bob,
        address recovery
    ) public {
