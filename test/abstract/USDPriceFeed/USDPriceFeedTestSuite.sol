...
import {USDPriceFeedHarness, MockPriceFeed, MockUptimeFeed, MockChainlinkFeed, RevertOnReceive} from "../../Utils.sol";
import {TestSuiteSetup} from "../../TestSuiteSetup.sol";

/* solhint-disable state-visibility */

abstract contract USDPriceFeedTestSuite is TestSuiteSetup {
    USDPriceFeedHarness internal usdPriceFeed;
    ...
    function setUp() public virtual override {
        ...
        usdPriceFeed = new USDPriceFeedHarness(
            priceFeed, uptimeFeed, INITIAL_USD_UNIT_PRICE, vault, roleAdmin, owner, operator, treasurer
        );
