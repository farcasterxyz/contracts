...
import {IdGatewayV2} from "../../src/IdGatewayV2.sol";

/* solhint-disable state-visibility */

abstract contract IdGatewayV2TestSuite is StorageRegistryTestSuite, KeyRegistryTestSuite {
    IdGatewayV2 idGateway;

    function setUp() public virtual override(StorageRegistryTestSuite, KeyRegistryTestSuite) {
        super.setUp();

        idGateway = new IdGatewayV2(address(idRegistry), owner);
